...
def merge_sort(time_start, liste_hsv, font, message, window, liste_rgb, a, d, radius, WHITE, NUM_SECTIONS):
    ...
    if n > 1:
        ...
        merge_sort(seconds, left_half, font, message, window, liste_rgb, a, d, radius, WHITE, NUM_SECTIONS)
        merge_sort(seconds, right_half, font, message, window, liste_rgb, a, d, radius, WHITE, NUM_SECTIONS)
