...
def HSV_to_RGB(time_start, liste_hsv, font, message, window, liste_rgb, a, d, radius, WHITE, NUM_SECTIONS):
    liste_rgb.clear()
    for h, s, v in liste_hsv:
        ...
        draw_sorting(time_start, font, message, window, liste_rgb, a, d, radius, WHITE, NUM_SECTIONS)